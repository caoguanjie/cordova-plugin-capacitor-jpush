...
JPushPlugin.prototype.getRegistrationDeviceToken = function(successCallback, errorCallback) {
    this.callNative("getRegistrationDeviceToken", [], successCallback, errorCallback);
};
...
JPushPlugin.prototype.addLocalNotificationForIOS = function(
    ...
    if (this.isPlatformIOS()) {
        this.callNative(
            "setLocalNotification", [delayTime, content, badge, notificationID, extras],
            null
        );
    }
};
...
JPushPlugin.prototype.deleteLocalNotificationWithIdentifierKeyInIOS = function(
    ...
    if (this.isPlatformIOS()) {
        this.callNative(
            "deleteLocalNotificationWithIdentifierKey", [identifierKey],
            null
        );
    }
};
...
JPushPlugin.prototype.addLocalNotification = function(
    ...
    if (device.platform === "Android") {
        this.callNative(
            "addLocalNotification", [builderId, content, title, notificationID, broadcastTime, extras],
            null
        );
    }
};
